...
public class HiddenTest {
    ...
    public void invalidAccountNumberTest() {
        assertEquals("1st and 2nd accounts were not assigned sequential account numbers.", john + 1, (long) julia);
        assertEquals("2nd and 3rd accounts were not assigned sequential account numbers.", julia + 1, (long) daniel);
        assertEquals("3rd and 4th accounts were not assigned sequential account numbers.", daniel + 1, (long) bob);
        assertEquals("4rd and 5th accounts were not assigned sequential account numbers.", bob + 1, (long) smith);
